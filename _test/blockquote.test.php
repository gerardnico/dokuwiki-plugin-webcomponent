...
class plugin_combo_blockquote_test extends DokuWikiTest
{
    ...
    public function test_blockquote_with_header()
    {
    ...
    public function test_blockquote_2_unmatched()
    {

        $element = syntax_plugin_combo_blockquote::TAG;
        $dokuContent = '<' . $element . ' >First unmatched **Help** Second unmatched</' . $element . '>';
        $expected = '<div class="card">' . DOKU_LF
            . '<div class="card-body">' . DOKU_LF
            . '<blockquote class="blockquote mb-0">' . DOKU_LF
            . 'First unmatched <strong>Help</strong> Second unmatched' . DOKU_LF
            . '</blockquote>' . DOKU_LF
            . '</div>' . DOKU_LF
            . '</div>' . DOKU_LF;
